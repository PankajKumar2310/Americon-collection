...
const Gallery = () => {
  ...
  const desktopMoments = [
    ...
    { id: 'moment-3', caption: translations.pages.gallery?.captions?.quietArrivals || 'Quiet arrivals', imageUrl: '/images/americonimages/175903-461844-pdoWwixIzOkYijW--MdrVbmA5m3uwT1LUsXGoYegxjb8-6932462b9f9c6.webp', position: { top: '55%', left: '30%' }, rotation: -3, size: { width: '25vw', height: '32vw' }, zIndex: 3 },
    ...
    { id: 'moment-5', caption: translations.pages.gallery?.captions?.detailsThatMatter || 'Details that matter', imageUrl: '/images/carriageimages/175903-461812-C2D82X-ib0NF4-tO8PSTMcI5EikjpQcTvzKeWwGfEHY-693229fabe007.webp', position: { top: '5%', left: '35%' }, rotation: 4, size: { width: '22vw', height: '28vw' }, zIndex: 0 },
