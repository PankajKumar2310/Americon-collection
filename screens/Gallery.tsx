...
const Gallery = () => {
  ...
  const desktopMoments = [
    ...
    { id: 'moment-3', caption: translations.pages.gallery?.captions?.quietArrivals || 'Quiet arrivals', imageUrl: '/images/americonimages/175903-461844-gdQVR-5JSAoS7Jtx4o91F5UsEfEbg5pXxAE4mWFT2b8-6932462240079.webp', position: { top: '55%', left: '30%' }, rotation: -3, size: { width: '25vw', height: '32vw' }, zIndex: 3 },
