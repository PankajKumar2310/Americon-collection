        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-serif flagship-anim">
              The American Estate: Our Flagship Property
            </h2>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground flagship-anim max-w-4xl mx-auto">
              At the heart of The American Collection is The American Estate, our flagship luxury retreat set on three private acres of land. This property represents everything we believe vacation accommodations should be: exceptional, memorable, and designed for creating stories worth telling.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6 flagship-anim">
              <img 
                ...
                alt="The American Estate - Luxury Pool Area"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 flagship-anim order-2 md:order-1">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  Despite its privacy and acreage, The American Estate is located just minutes from Kansas City's major transportation corridors, making it easy for international travelers and groups to reach Arrowhead Stadium, downtown Kansas City attractions, and the region's entertainment districts.
                </p>
              </div>
            </div>
            <div className="space-y-6 flagship-anim order-1 md:order-2">
              <img 
                ...
                alt="The American Estate - Fire Pit Area"
                className="w-full h-64 md:h-96 object-cover rounded-lg shadow-xl"
              />
            </div>
          </div>
