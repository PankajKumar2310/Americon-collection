...
const images = [
  ...
  { src: "/images/carriageimages/175903-461812-H7r5IatIJ-JJWkVXrY3RuazX--ptgMqub0dtPESMYd6k-693229f56d8bc.webp", alt: "Carriage House interior", className: "w-[40vw] md:w-[20vw] top-[50%] left-[15%] rotate-8" },
