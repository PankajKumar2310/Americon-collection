...
const ListingPageLayout = ({ title, descriptor, heroImageUrl, bookingLink, children }: ListingPageLayoutProps) => {
  ...
  return (
    <div ref={layoutRef}>
      <section className="relative min-h-[80vh] md:min-h-screen flex flex-col justify-center  text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto md:pt-2 pb-16 md:pb-24 text-center">
      ...
      <main className="bg-background py-10 md:py-32">
